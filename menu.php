...
<head>
	...
	<title>Blue Sky Summer - Mağaza Sayfası</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span> <a href="home.php">Anasayfa</a><i class="bx bx-right-arrow-alt"></i>Mağazamız </span> 
        </div>
    </div>
    <div class="products">
        <div class="heading">
            <h1>En Yeni Lezzetlerimiz</h1>
            <img src="image/separator-img.png">
        </div>
        <div class="box-container">
            <?php 
                $select_products = $conn->prepare("SELECT * FROM `urunler` WHERE durum = ?");
